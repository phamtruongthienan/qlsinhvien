...
<div class="login-box">
    <div class="login-logo">
        <a href="{{asset('/')}}"><b>Quản lý</b>Thông Tin Sinh Viên</a>
    </div>
    <!-- /.login-logo -->
    @if ( $errors->count() > 0 )
    ...
    <div class="login-box-body">
        ...
        <form id="login-form" role="form" data-toggle="validator" action="actionLogin"  method="POST">
            {!! csrf_field() !!}
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary btn-block"
                            data-loading-text="<i class='fa fa-spinner fa-spin '></i>">Sign In</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
