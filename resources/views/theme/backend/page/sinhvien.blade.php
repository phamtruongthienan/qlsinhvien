            ...
            <div class="nav-tabs-custom posr">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="listLevel">
                        ...
                        @include('theme.backend.section.sinhvien.table_sinhvien_school')
                        @include('theme.backend.section.sinhvien.modal_sinhvien_school')
                    </div>
                    <!-- /.tab-pane -->
                </div>
                <!-- /.tab-content -->
...
@section('script')
    <script src="{{asset('assets/backend/build/pages/js/sinhvien.js')}}"></script>
@endsection