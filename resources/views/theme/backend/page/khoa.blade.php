...
@section('content')
<h2 class="page-header">Quản Lý Khoa{{$data}}</h2>
        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom posr">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#listLevel" data-toggle="tab">Danh sách khoa</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="listLevel">
                        ...
                        @include('theme.backend.section.khoa.table_khoa_school')
                        @include('theme.backend.section.khoa.modal_khoa_school')
                    </div>
                    <!-- /.tab-pane -->
                </div>
                <!-- /.tab-content -->
...
@section('script')
    <script src="{{asset('assets/backend/build/pages/js/khoa.js')}}"></script>
@endsection